...
const Navbar = () => {
  return (
    <>
      <nav className="h-25 white black flex justify-between items-center px-5 shadow position-sticky top-0 gap-10 position-sticky top-0">
        ...
        <div className=" flex items-left w-full justify-between items-center gap-10">
          ...
          <div className="flex gap-3 items-center ">
            <a
              href="#"
              className="bg-[#BF4408] text-white px-4 py-1 rounded-full bold "
            >
              <b>Resume</b>
            </a>
            <a
              href="#"
              className="border border-[#BF4408] text-[#BF4408] px-4 py-1 rounded-full "
            >
              <b>Hire Me</b>
            </a>
          </div>
